...
![Запись в файл](image/1.png){#fig:001 width=80%}

![Вывод содердимого](image/2.png){#fig:002 width=80%}

![Дописывание в файл](image/3.png){#fig:003 width=80%}

3. Выведите имена всех файлов из file.txt, имеющих расширение .conf, после чего запишите их в новый текстовой файл conf.txt.

![вывод файлов с расширением .conf](image/4.png){#fig:004 width=80%}

![результат](image/5.png){#fig:005 width=80%}

![запись фйалов в conf.txt](image/6.png){#fig:006 width=80%}

4. Определите, какие файлы в вашем домашнем каталоге имеют имена, начинавшиеся с символа c? Предложите несколько вариантов, как это сделать.

![определение файлов начинающихся на с](image/7.png){#fig:007 width=80%}

![результат](image/8.png){#fig:008 width=80%}

![вариант 2](image/9.png){#fig:009 width=80%}

![вариант 3](image/10.png){#fig:010 width=80%}

![результат](image/11.png){#fig:011 width=80%}

5. Выведите на экран (по странично) имена файлов из каталога /etc, начинающиеся с символа h.

![определение файлов начинающихся на h](image/12.png){#fig:012 width=80%}

![результат](image/13.png){#fig:013 width=80%}

6. Запустите в фоновом режиме процесс, который будет записывать в файл ~/logfile файлы, имена которых начинаются с log.

![запуск процесса](image/14.png){#fig:014 width=80%}

![результат](image/15.png){#fig:015 width=80%}

7. Удалите файл ~/logfile.

![удаление файла](image/16.png){#fig:016 width=80%}

8. Запустите из консоли в фоновом режиме редактор gedit. 

![запуск gedit](image/17.png){#fig:017 width=80%}
...
![чтение справки, df](image/19.png){#fig:019 width=80%}

![ввод du](image/20.png){#fig:020 width=80%}

12. Воспользовавшись справкой команды find, выведите имена всех директорий, имеющихся в вашем домашнем каталоге.

![стение справки find](image/21.png){#fig:021 width=80%}

![вывод директорий](image/22.png){#fig:022 width=80%}

![результат](image/23.png){#fig:023 width=80%}
